...
public class GuiElementsTest extends BaseTest {
    ...
    // ── Test Data ────────────────────────────────────────────────
    private static final String NAME         = "Sourav Singh";
    private static final String EMAIL        = "heaveneater@gmail.com";
    private static final String PHONE        = "1234567890";
    private static final String ADDRESS      = "Jharsugda, Odisha";
    ...
    private static final String ANIMAL       = "Rabbit";
    private static final String DATE1        = "03/25/2026";
    ...
    private static final String SINGLE_FILE  =
        "C:\\Users\\SOURAV SINGH\\OneDrive\\Desktop\\Wipro Assignments\\1776959736860-Assignment SDET - Day 1.pdf";
    private static final String FILE1        =
        "C:\\Users\\SOURAV SINGH\\OneDrive\\Desktop\\Wipro Assignments\\1778330467761-Assignment APRIL SDET - Day 15.pdf";
    private static final String FILE2        =
        "C:\\Users\\SOURAV SINGH\\OneDrive\\Pictures\\images.jpg";
    private static final String WIKI_SEARCH  = "Selenium";
    private static final String PROMPT_TEXT  = "Sourav Singh";
    private static final String DC_TEXT      = "Sourav Singh";
    private static final String COMBO_ITEM   = "Item 5";
...
String path = ScreenshotUtil.capture(BaseTest.driver, stepName);
    ...
    public void tc09_DatePickers() {
        ...
        try {
            ...
            page.enterDateRange(START_DATE, END_DATE);
            test.log(Status.INFO, "Date Range: <b>"
                + START_DATE + "</b> to <b>" + END_DATE + "</b>");
